<?php
// File: allFreelancer.php
// Description: Page to display all freelancers
// Features:
// - Displays a list of freelancers
// - Allows searching by username, name, and email
// - Redirects to view freelancer details upon selection
...
if (isset($_POST["s_name"]) && !empty($_POST["s_name"])) { // Search by name
    $sql = "SELECT * FROM freelancer WHERE Name LIKE ?";
...
if (isset($_POST["s_email"]) && !empty($_POST["s_email"])) { // Search by email
    $sql = "SELECT * FROM freelancer WHERE email LIKE ?";
    ...
    <div class="container-fluid" style="padding-left: 0; padding-right: 0;">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse" style="margin-right: 0;">
            <ul class="nav navbar-nav navbar-right" style="margin-right: 0;">
                ...
                <li class="active" style="background-color: #000;"><a href="allFreelancer.php">Browse Freelancers</a></li>
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        <form action="allFreelancer.php" method="post">
                                            <input type="hidden" name="f_user" value="'.htmlspecialchars($row["username"]).'">
                                            <td>
                                ...
                                echo '<tr><td colspan="5" class="text-center">No freelancers found</td></tr>';
                            }
                            ?>
                            </tbody>
                        </table>
        ...
        <div class="col-lg-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- Search by Username -->
                    <form action="allFreelancer.php" method="post" class="search-form">
